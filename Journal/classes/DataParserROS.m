...
%             %start-dp
%             obj.measurement_sequences = unique(d(:,4));
%             for i=1:length(d)
%             if d(i,2)==10||d(i,3)==10
%                 obj.quadcopter_timinglogs = [obj.quadcopter_timinglogs; d(i,:)];
%             end
%             end
%             csvwrite('logs/quadcoptermeasurement.csv',obj.quadcopter_timinglogs);
%             %end-dp
