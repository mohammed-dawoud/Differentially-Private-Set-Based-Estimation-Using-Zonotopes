...
for i=1:length(raw_measurements)
    %dp-start-measurement-noise-start
            ...
            %dp-optimal-noise-end
            temp = raw_measurements(i,4)+p1+resultdp_opt1;
...
legend({'Error in presence of the differential privacy noise (Optimal noise) CDP','Error without the differential privacy noise'}, 'Orientation', 'vertical', 'Location', 'NE');
